...
map({ 'n', 't' }, '<A-h>', '<cmd>vertical resize -5<CR>', { desc = 'Resize split left' })
map({ 'n', 't' }, '<A-l>', '<cmd>vertical resize +5<CR>', { desc = 'Resize split right' })
map({ 'n', 't' }, '<A-j>', '<cmd>resize -5<CR>', { desc = 'Resize split down' })
map({ 'n', 't' }, '<A-k>', '<cmd>resize +5<CR>', { desc = 'Resize split up' })
